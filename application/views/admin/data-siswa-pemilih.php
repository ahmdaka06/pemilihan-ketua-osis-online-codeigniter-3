<title>Data Siswa Pemilih || E-Pilketos</title>
...
<section class="content">
  ...
  <div class="box box-primary">
    <div class="box-header with-border">
      ...
      <button class="btn btn-success btn-flat"  data-toggle="modal" data-target="#modal-tambah-excel">
        <i class="fa fa-plus"></i> 
        Tambah Data Excel
      </button>
  ...
  <!-- Modal -->
  <div class="modal fade" id="modal-tambah-excel">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <a href="<?= base_url() ?>contoh/format-data-siswa.xls" target="_blank" class="btn btn-success btn-flat">
...
<!-- /.content -->
<script src="<?= base_url() ?>assets/js/ajax-data-siswa.js"></script>